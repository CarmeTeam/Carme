...
DEFAULT_VARIABLES=("CARME_VERSION" "CARME_SCRIPT_PATH" "CARME_BACKEND_PATH" "CARME_MESSAGE_PATH" "CARME_FRONTEND_PATH" "CARME_SLURM_CONFIG_FILE" "CARME_SCRIPTS_PATH" "CARME_ZABBIX_GRAPH_PATH")
#-----------------------------------------------------------------------------------------------------------------------------------
